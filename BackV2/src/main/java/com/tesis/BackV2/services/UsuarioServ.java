...
public class UsuarioServ {
    ...
    public UsuarioDTO buscarUsuario(String cedula) throws MiExcepcion {
        ...
        EstudianteDTO estudianteDTO = estudiante != null ? EstudianteDTO.builder()
                ...
                .idMatricula(m == null ? 0 : m.getId())
                .curso(m == null || m.getCurso() == null ? "" : m.getGrado().getNombre() + " - " + m.getCurso().getParalelo())
    ...
    // Traer usuarios docentes
    public List<UsuarioDTO> getDocentes() {
        List<Usuario> usuarios = repoU.findByRol(Rol.DOCENTE);
